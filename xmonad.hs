...
import XMonad.Layout.Gaps              -- gaps [(U,18), (R,23)]  ; not used as inefficient real estate!
...
-- "windows key" is usually mod4Mask. Use xmodmap to find out.
--
myModMask       = mod1Mask
...
--
myLayout = noBorders (tiled ||| Full ||| Mirror tiled)
  where
